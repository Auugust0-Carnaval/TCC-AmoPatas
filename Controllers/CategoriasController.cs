...
namespace AmoPatass
{
    ...
    public class CategoriasController : Controller // heranca da classe ControllerBase para ter as mesma caracteristicas e metodos
    {
        ...
        public async Task<IActionResult> GetAsync()
        {
            ...
            {
                return BadRequest(ex.Message); // exibe e mensagem do try(system.exception)
            }
        }
        ...
        [HttpDelete("{id}")] // na url precisa ser declarado o Idcategory para a exclusão da informação
