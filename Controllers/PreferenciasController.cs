...
{ 
  ...
  public class PreferenciasController : ControllerBase
  {
    ...
    // Retornando os pets que sejam da categoriapassada por parametro
    ...
    // {
    //   List<Pet> petCategoria =  new List<Pet>{};
    //   foreach (var pet in petCategoria)
    //   {
    //     foreach (var Categoria in cat)
    //     {
    //       if (pet.IdCategoria != null) {
    //          petCategoria.Add(pet);
    //          break;
    //       }
...
>>>>>>> 0f9b5510951c78df686d63cfc5ca4b71f6403fcf
